  ...
  try {
    ...
    const result = streamText({
      ...
      system: 'You are a helpful AI assistant. Be concise and helpful in your responses. ' +
        'If the user asks you to draw, create, generate, or make a picture/image/photo, ' +
        'tell them to use the image button next to the message box to generate images.',
